...
const ProjectTimeline = ({ phases, project }: ProjectTimelineProps) => {
  const shouldHideDistribucijaAndTisk = !project.is_for_tisk;
  return (
    <div className="flex flex-col">
      {project_phases.map((project_phase) => {
        ...
        if (
          shouldHideDistribucijaAndTisk &&
          (project_phase.url === "distribucija" || project_phase.url === "tisk")
        ) {
          return null;
        }
        ...
        const showVerticalLine = !(
          shouldHideDistribucijaAndTisk &&
          project_phase.url === "priprava-in-oblikovanje"
        );
        return (
          <div key={project_phase.url} className="flex gap-8 items-start">
            ...
            <div className="flex flex-col items-center">
              ...
              {project_phase.url !== "distribucija" && showVerticalLine && (
